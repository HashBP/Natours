    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _realData = _context.sent;
            console.log(_realData);

            if (_realData.status === 'Success') {
              (0, _alert.showAlert)('success', 'Logged In successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            } else (0, _alert.showAlert)('error', _realData.message);
          ...
          case 12:
            ...
            (0, _alert.showAlert)('error', realData.message);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFzaGJpdCIsImEiOiJjbDR6ZGFuOWwyY2k0M2pudXZwZXI3Z2Q4In0.Bu3qWSi_lnUPzPzU_1tOCg';
